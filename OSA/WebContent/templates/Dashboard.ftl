   ...
   <section class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6 ">
               <h3>Main Page</h3>
               <p>Here you can access everything u can do after Registeration </p>
            </div>
            <div class="col-sm-6">
            </div>
         </div>
      ...
      <div class="container-fluid">
         ...
         <!-- Card Sample --> 
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6" style="margin-bottom: 15px;">
               <a class="x-a" href="AllProductsOverview">
                  <div class="card text-center x-card x-card-height180 x-linkcard" style="padding-bottom: 0.5rem;">
                     <div class="card-body">
                        <span>
                        <i class="fas fa-tachometer-alt"></i>
                        </span>
                        <h2 class="x-card-title x-color mb-1">Products OverView</h2>
                        <div class="card-text">Here you can show all Products</div>
                     </div>
                  </div>
               </a>
            </div>
